        ...
        <div id="main">
            ...
            <section id="content">
                ...
                <div class="description">
                    <p>                        
                        Les charpentiers de la SARL <strong>Ducrozet-Moninot</strong>assurent la pose de charpentes et de couvertures sur bâtiment neuf ou ancien depuis 15 ans maintenant dans la région de Bourg en Bresse.<br />
                    ...
                    <div>
                       <!-- <h3>Travaux de Charpente - Couverture :</h3> -->
                        <ul>
                            <li>Réfection complète de Charpente - Couverture.</li>
                            ...
                            <li>Pose de Frisette PVC ou Bois sous <a href="https://fr.wiktionary.org/wiki/forget">forget</a>.</li>
